/* 
    ...
    Responsible for:
      ...
      - The navbar hide/show on scroll functionality
      - Ensuring the page is bfcache-friendly (i.e. the page is loaded 
        from the cache when the user navigates back to the page)
*/
